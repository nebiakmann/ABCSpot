...
namespace ABCSpot.BL
{
    public static class BLogic
    {
        ...
        internal static bool UrunEkle(Model u)
        {
            try
            {
        ...
        internal static bool UrunGüncelle(Model u)
        {
            try
            {
        ...
        internal static bool UrunEkle(UI.Model model)
        {
            throw new NotImplementedException();
        }

        internal static bool ModelGüncelle(UI.Model model)
        {
            throw new NotImplementedException();
        }
    }
